...
import { getCategoryArticlePageList } from '@/api/frontend-api';
...
const CategoryArticleList = () => {
  ...
  console.log('Category loaderData', loaderData);
  return (
    <>
      {/* <Header /> */}
          ...
          <div className='col-span-4 md:col-span-3 mb-3'>
            ...
            <div className='p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700'>
              <h1 className='flex items-center text-lg font-semibold text-gray-900 dark:text-white'>
                {/* <!-- 文件夹图标 --> */}
                <svg
                  className='inline w-4 h-4 mr-2 dark:text-white'
                  aria-hidden='true'
              ...
              {!loaderData?.artRes && (
                ...
                >
                  ...
                  <p className='mt-2 mb-16 text-gray-400'>No results~</p>
                </div>
              )}
            </div>
          </div>
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  const [artErr, artRes] = await to(getCategoryArticlePageList(q));
  ...
  if (artErr || cateErr || tagErr) return null;
  return {
    artRes: artRes?.data,
