...
//    }
    ...
    @ApiOperation(value = "查询文章数据")
    @ApiOperationLog(description = "查询文章数据")
    public Response findArticleInfo(@RequestBody @Validated FindArticleInfoReqVO findArticleInfoReqVO) {
        return articleService.findArticleInfo(findArticleInfoReqVO);
    }
