...
import ArticlePublishCalendar from '@/components/frontend/ArticlePublishCalendar';
import ArticlePVLineChat from '@/components/frontend/ArticlePVLineChat';
...
const Index = () => {
  ...
  console.log('pvInfo', loaderData?.pvInfo);
      ...
      <main className='container p-4'>
        ...
        <div className='grid grid-cols-4 gap-7'>
          ...
          <div className='col-span-4 md:col-span-1'>
            <div className='flex items-center w-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700'>
              <svg
                t='1699865769161'
          ...
          {/* <!-- 总浏览量 --> */}
          <div className='col-span-4 md:col-span-1 bg-teal-500'>
            <div className='flex items-center w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700'>
              <svg
                t='1699866701804'
                class='icon w-10 h-10'
                viewBox='0 0 1024 1024'
          ...
          {/* <!-- 文章发布热点图 --> */}
          <div className='col-span-4 md:col-span-2 bg-blue-500'>
            <div className='w-full h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700'>
              <h2 className='flex items-center mb-2 font-bold text-gray-900 uppercase dark:text-white'>
                ...
                daily article publishing heatmap
              </h2>
              <div>
                <ArticlePublishCalendar heatMapInfo={loaderData?.heatMapInfo} />
              </div>
            </div>
          </div>

          {/* <!-- 文章日 PV 访问量折线图 --> */}
          <div className='col-span-4 md:col-span-2 bg-indigo-500'>
            {/* <!-- 卡片 --> */}
            <div className=' h-full px-5 py-7 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700'>
              <h2 className='flex items-center mb-2 font-bold text-gray-600 uppercase dark:text-white'>
                {/* <!-- 折线图标 --> */}
                <svg
                  t='1699872552774'
                  class='icon w-5 h-5 mr-2'
                ...
                PV (Page View) count in the past week
              </h2>
              <ArticlePVLineChat pvInfo={loaderData?.pvInfo} />
            </div>
          </div>
        </div>
      </main>
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  const [err, info] = await to(getBaseStatisticsInfo());

  const [err2, heatMapInfo] = await to(getPublishArticleStatisticsInfo());
  // console.log(info);
  // console.log('heatMapInfo', heatMapInfo);

  const [err3, pvInfo] = await to(getArticlePVStatisticsInfo());
  if (err || err2 || err3) return null;
  return {
    info: info.data,
    heatMapInfo: heatMapInfo.data,
    pvInfo: pvInfo.data,
  };
};
